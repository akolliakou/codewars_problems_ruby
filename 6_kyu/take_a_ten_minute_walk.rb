...
# takes you one minute to traverse one city block, so create a function 
# that will return true if the walk the app gives you will take you exactly 
# en minutes (you don't want to be early or late!) and will, of course, 
...
def is_valid_walk(arr)
  ...
  arr.count(arr.uniq[0]) == arr.count(arr.uniq[1])
end